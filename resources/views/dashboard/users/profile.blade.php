                ...
                <div class="row gutters">
                            ...
                            <div class="card-body">
                                <div class="account-settings">
                                    <div class="profile-pic text-center">
                                        @if( ($user->avatar ?? "" ) == "" )
                                            <a data-toggle="modal" data-sent_data="{{$user}}"
                                               data-target="#modal-edit-user-image">
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::user()->id ==  $user->id )
                                        ...
                                        <form id="update_user" method="POST"
                                              action="{{route('user.admin.update.image', $user )}}"
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <button type="submit" class="btn btn-xs btn-secondary">Update Image
                                                </button>
                                            </div>
                                        </form>
                                    @endif
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                        <div class="card h-100">
                            <div class="card-body">
                                <form id="update_user" method="POST"
                                      action="{{route('user.client.update', $user->id )}}">
                                    @csrf
                                    <fieldset>
                                        <div class="row gutters">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$user->nid}}" class="form-control"
                                                           id="nid" name="nid"
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" value="{{$user->plot_street ?? "" }}"
                                                           class="form-control" id="Street" name="plot_street"
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="role_id"
                                                            @if(\Illuminate\Support\Facades\Auth::user()->role_id !=  config('constants.role.admin.id')) readonly @endif
                                                    >
                                                        <option
                    ...
                    @if(( auth()->user()->id ?? 0 ) != $user->id )
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card card-footer mt-4 mb-7">
                                <form role="form12" method="post" action="{{route('user.destroy', $user)}}">
                                    @csrf
{{--                                    <div class="modal-body">--}}
{{--                                        <div class="row">--}}
{{--                                            <div class="col-12">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <input hidden type="text" class="form-control" id="delete-user-name"--}}
{{--                                                           name="name" value="{{$user->name}}"--}}
{{--                                                           placeholder="Enter Name" readonly required>--}}
{{--                                                </div>--}}
{{--                                                <input hidden type="text" class="form-control" id="delete-user-id"--}}
...
{{--                                    </div>--}}
                                    <div class="justify-content-between">
                                        <span class="text-danger ">Do you want to delete this user ? Action will not be reversed : </span>
