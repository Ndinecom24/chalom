    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="container-sm">
                <div class="row ">
                    <div class="col-sm-6">
                        <h3 class="page-heading mb-4">Work Status</h3>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-8 offset-2 col-lg-8 offset-2  col-md-8 offset-2  col-sm-12 offset-2  col-12">
                        <div class="card h-100">
                            <div class="card-body">
                                <!-- form start -->
                                <form role="form" method="post" action="{{route('work.status.update', $work_status)}}">
                                    @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputRoleName"
                                                           name="name" value="{{$work_status->name}}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputRoleDescription"
                                                           name="description"  value="{{$work_status->description}}"
