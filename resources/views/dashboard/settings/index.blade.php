                                        ...
                                        <div class="col-12">
                                            <table  class="table table-striped">
                                                ...
                                                @foreach($statuses as $status)
                                                    <tr>
                                                        <td> {{$status->id}} </td>
                                                        <td><span class=" text-{{$status->html ?? 'info'}}">{{$status->name}}</span> </td>
                            ...
                            <div class="card">
                                ...
                                <div id="collapse5" class="collapse show" aria-labelledby="heading5"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <a class="btn btn-sm btn-outline-success mb-2"  href="{{route('loan.category.create')}}">
                                                    New Loan Category
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                @foreach($loanCategories as $loanCategory)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row ">
                                                                <div class="col-3">
                                                                    <a class="btn btn-sm btn-secondary"  href="{{route('loan.category.show', $loanCategory )}}" >
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
