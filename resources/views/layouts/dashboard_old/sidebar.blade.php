<nav class="bg-white sidebar sidebar-offcanvas" id="sidebar">
    ...
    || \Illuminate\Support\Facades\Auth::user()->role_id  ==  config('constants.role.admin.id')
        ...
        <!-- borrower option -->
            ...
            <!-- loan option -->
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#loans-pages" aria-expanded="false"
                   aria-controls="liability-pages">
                    <i class="fa fa-money"></i>
                    <span class="menu-title">Loan Products <i class="fa fa-sort-down"></i> </span>
                </a>
                <div class="collapse" id="loans-pages">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('loan.product.index')}}"> <i class="fa fa-money"></i>
                                Loan Products List</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <!-- settings option -->
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#settings-pages" aria-expanded="false"
                   aria-controls="liability-pages">
                ...
                <div class="collapse" id="settings-pages">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{route('user.admins')}}"> <i class="fa fa-user-circle"></i>
                                Admins</a>
                        </li>
                        <li class="nav-item">

                            <a class="nav-link" href="{{route('user.clients')}}"> <i class="fa fa-user-circle-o"></i>
                                Clients</a>
                        </li>
                    </ul>
                </div>
