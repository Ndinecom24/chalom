        ...
        <div class="collapse navbar-collapse" id="navbar-default">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="{{route('welcome')}}" id="navbarHome" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            @else
                <div class="ms-lg-3 mt-3 d-grid mt-lg-0 text-end" >
                    @if( (Auth::user()->avatar ?? "" ) == "" )
                        <img class="nav-item " width="50px" src="{{asset('images/user.png')}}" alt="">
                    @else
                        <img class="nav-item " width="50px" src="{{Auth::user()->avatar ?? ""}}" alt="{{asset('images/user.png')}}">
                    @endif
                </div>
                <div class="ms-lg-3 mt-3 d-grid mt-lg-0"   >
                    <ul class="navbar-nav ms-auto">
